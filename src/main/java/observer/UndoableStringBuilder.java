...
class UndoableStringBuilder {
    ...
    private UndoableStringBuilder(StringBuilder builder, Stack<Action> actionsToCopy){
        stringBuilder = new StringBuilder(builder.toString());
        actions = (Stack<Action>)actionsToCopy.clone();
    }
